...
class Obj1 extends _1.GraphNode {
    constructor(value) {
        super();
        this.value = value;
...
__decorate([
    (0, _1.incomingEdgeView)('child1')
], Obj1.prototype, "_prop1", void 0);
__decorate([
    (0, _1.queryEdgeView)(query_1.query.throughOutgoingEdge('child1').throughOutgoingEdge('child1'))
], Obj1.prototype, "_doubleProp1", void 0);
__decorate([
    (0, _1.queryEdgeView)(query_1.query.throughOutgoingEdge('child1').throughIncomingEdge('child1'))
